...
export default function KeyboardShortcuts({ isOpen, onClose }: KeyboardShortcutsProps) {
  const shortcuts: Shortcut[] = [
    ...
    { keys: ['g', 'h'], description: 'Go to Overview', category: 'Navigation' },
    { keys: ['g', 's'], description: 'Go to Service Health', category: 'Navigation' },
    { keys: ['g', 'a'], description: 'Go to Incidents & Alerts', category: 'Navigation' },
